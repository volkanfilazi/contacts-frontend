...
<template>
  <div class="flex flex-col gap-5 justify-center items-center h-screen">
    ...
    <button @click="fetchLogin(email,password)" class="border-[1px] border-yellow-400 p-2 text-white"><span v-if="!loading">Login</span><span v-if="loading"><div role="status">
